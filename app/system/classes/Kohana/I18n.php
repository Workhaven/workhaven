...
if ( ! function_exists('__'))
{
	...
	function __($string, array $values = NULL, $lang = 'en-us')
	{
                ...
                $messages = I18n::load(I18n::$lang);
                //print_r($messages);                                               
                                
                $file = Kohana::find_file('i18n', I18n::$lang, NULL, FALSE);
                ...
                if ( isset($file[0]) && file_exists($file[0]) ) {                    
                    ...
                    if( array_key_exists($string, $messages )){
                        ...
                        $file_content = "<?php defined('SYSPATH') OR die('No direct script access.');".
                                        "return ".
                                            var_export( $messages, TRUE).
                                        ";";

                        file_put_contents($file[0], $file_content);                    
                    }           
                }
