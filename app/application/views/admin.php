...
<body>
    <div class="wrapper">
      <div class="navbar-wrapper">        
        <?php echo PartialView::factory("admin/_partials/Menu", NULL, TRUE); ?>         
      </div>             
      <?php echo $content ?>          
      <?php echo PartialView::factory("admin/_partials/Footer", NULL, TRUE); ?>
    </div>
    <?php echo PartialView::factory("admin/_partials/Hidden", NULL, TRUE); ?>        
